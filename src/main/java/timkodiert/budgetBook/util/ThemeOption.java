...
import static timkodiert.budgetBook.util.OperatingSystem.LINUX;
import static timkodiert.budgetBook.util.OperatingSystem.OSX;
import static timkodiert.budgetBook.util.OperatingSystem.WINDOWS;
